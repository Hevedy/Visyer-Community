...
#include "CableActorLocal.h"
#include "CableComponentLocal.h"

ACableActorLocal::ACableActorLocal( const FObjectInitializer& _ObjectInitializer )
	: Super( _ObjectInitializer.SetDefaultSubobjectClass<UCableComponentLocal>(TEXT( "CableComponent0" )) ) {
}
